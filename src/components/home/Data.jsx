...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Blockchain Dev</h3>
            <p className="home__description">Hi, I'm Abhishek Yadav, a Blockchain developer building creative Smart Contracts && decentralized applications (dApps).</p>
